def main():
    ...
    if dificulte == "commandes":
        print('taper "credit" pour visionner les crédits; taper"nouvelle partie" pour commancer une novelle partie; taper"quitter" pour quitter; taper commandes pour voir les commandes')
        commandes = 1
