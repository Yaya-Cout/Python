...
def attendre(secondes=1, message=""):
    """attendre sert à attendre le temps demandé (par défaut le temps est 1 seconde) et à afficher le texte demandé(exemple: attendre(2,"test") attendre va attendre 2 secondes en affichant test.)"""
